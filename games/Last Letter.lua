...
local Settings = {
  ...
  Words = {
    ...
    ToBlacklist = "",
    ToUnblacklist = "",
    Blacklist = { "horcrux", "seeland", "seelie", "grawlix", "erx", "erbitux", "erymax", "boxx", "isocortex", "isx", "amoureux", "itx", "yux", "yandex", "urbex", "urox", "endocervix", "noncomplex", "xxx", "ianthe", "iand", "atex", "endoclimax", "entonox", "wessex", "skybox", "opex", "icex", "gedex", "kendrix", "axx", "etx", "yax", "anex", "edx", "edex", "edax", "editrix", "edronax", "ygx", "ymx", "xanax", "xx", "xxxx", "xenix", "xfx", "xox", "xfx", "xilinx", "xanadu", "yunx", "acex", "selex", "upx", "sonex", "nexx", "checkbox", "xxix", "xp", "xiphias", "allex", "albiorix", "tickbox", "texmex", "textbox", "emex", "edix", "edomex", "edsx", "ningen", "xorn", "xoanon", "xenocide", "xor", "tedax", "anancastic", "lamoureaux", "onx", "lamoureux", "lamoreaux", "onix", "deass", "selinux", "rolodex", "isindex", "ispbx", "olx", "netflix", "umx", "gygax", "omex", "omnimax", "omnifax", "omx", "tantrix", "tanx", "tanapox", "yaldabaoth", "idn", "idnx", "idx", "xxxxx", "xn", "owerri", "xbone", "asx", "asterix", "astyanax" },
    Cache = {},
  },
  Keys = {
