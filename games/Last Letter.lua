...
local Settings = {
  ...
  Words = {
    ...
    ToBlacklist = "",
    ToUnblacklist = "",
    Blacklist = { "horcrux", "seeland", "seelie", "grawlix", "erx", "erbitux", "erymax", "boxx", "isocortex", "isx", "amoureux", "itx", "yux", "yandex", "urbex", "urox", "endocervix", "noncomplex", "xxx", "ianthe", "iand", "atex", "endoclimax", "entonox", "wessex" },
    Cache = {},
  },
  Keys = {
